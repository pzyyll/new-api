// ABOUTME: Persists usage logs and filters metadata by viewer privileges.
// ABOUTME: Keeps request detail bodies out of list responses and new log rows.
package model
...
// stripLogDetailBodies keeps list responses small; the detail API loads bodies on demand.
