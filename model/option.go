...
func InitOptionMap() {
	...
	common.OptionMap["StripeWechatPayEnabled"] = strconv.FormatBool(setting.StripeWechatPayEnabled)
	common.OptionMap["StripeAlipayEnabled"] = strconv.FormatBool(setting.StripeAlipayEnabled)
	...
	common.OptionMap["UpstreamCapacityKeywords"] = operation_setting.UpstreamCapacityKeywordsToString()
...
func updateOptionMap(key string, value string) (err error) {
	...
	case "StripeWechatPayEnabled":
		setting.StripeWechatPayEnabled = value == "true"
	case "StripeAlipayEnabled":
		setting.StripeAlipayEnabled = value == "true"
	case "CreemApiKey":
	...
	case "UpstreamCapacityKeywords":
		operation_setting.UpstreamCapacityKeywordsFromString(value)
