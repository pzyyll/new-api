...
func GetChannel(group string, model string, excludedChannelIds map[int]struct{}, allowMultiKeyFallback bool, userAgent string, requestPath string, filters ...dto.ChannelFilter) (*Channel, error) {
	var abilities []Ability
