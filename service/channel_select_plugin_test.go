// ABOUTME: Verifies task-plugin identity filters used during channel selection.
// ABOUTME: Covers pinned generation indexes, generic keys, and shared endpoint providers.
package service
