...
> = {
  ...
  [CHANNEL_TYPE_OPEN_CODE_GO]: {
    descriptionKey: 'Connect to OpenCode Go model services',
  },
  [CHANNEL_TYPE_SUB2API]: {
    descriptionKey: 'Connect to model services through a Sub2API gateway',
  },
...
export const TYPE_TO_KEY_PROMPT: Record<number, string> = {
  ...
  [CHANNEL_TYPE_OPEN_CODE_GO]: 'Enter API key for this channel',
  [CHANNEL_TYPE_SUB2API]: 'Enter API key for this channel',
