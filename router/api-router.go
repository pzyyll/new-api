...
func SetApiRouter(router *gin.Engine) {
	...
	anonymousRequestBodyLimit := middleware.AnonymousRequestBodyLimit()
	{
		...
		logRoute.GET("/request-detail", middleware.AdminAuth(), controller.GetLogRequestDetail)
		logRoute.GET("/self/request-detail", middleware.UserAuth(), controller.GetUserLogRequestDetail)
		logRoute.GET("/request-detail/storage", middleware.RootAuth(), controller.GetRequestDetailStorageInfo)
		logRoute.DELETE("/request-detail", middleware.RootAuth(), controller.ClearRequestDetailFiles)
